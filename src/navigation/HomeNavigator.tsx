...
const TabNavigatorContent = createBottomTabNavigator({
  Glossary: {
        ...
        navigationOptions: {
            title: "Glossaire",
            tabBarIcon: ({ focused }) => <HomeNavigatorIcon name="list-ul" focused={focused} />,
        },
    },
  ScannerNavigator: {
      ...
      navigationOptions: {
        title: "Scanner",
        tabBarIcon: ({ focused }) => <HomeNavigatorIcon name="camera" focused={focused} />,
      },
  },
  Account: {
    screen: Account,
    navigationOptions: {
      title: "Profil",
      tabBarIcon: ({ focused }) => <HomeNavigatorIcon name="user" focused={focused} />,
    },
},
});
