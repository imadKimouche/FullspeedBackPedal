...
export default class SwipeHandler extends React.Component<IProps> {
   ...
   * @private
   */
  private _handleShouldSetPanResponder(
   ...
   * @private
   */
  private _handlePanResponderEnd(
    evt: GestureResponderEvent,
    gestureState: PanResponderGestureState,
  ): void {
   ...
   * @private
   */
  private _isValidHorizontalSwipe(
    gestureState: PanResponderGestureState,
  ): boolean {
